...
from Minerva7B.T1_Traduzione.training.common import (MODEL_REGISTRY, load_backbone, load_hf_token, load_split,
...
def prompt_t3_con_contesto(prompt_modello, turni):
    ...
    from Minerva7B.T1_Traduzione.training.contesto_metrica import _e_separatore
...
def main():
    ...
    if a.lessico and a.task == "T1" and a.frase:
        from Minerva7B.T1_Traduzione.training.pesi_lessicali import carica_lessico, tokenizza
