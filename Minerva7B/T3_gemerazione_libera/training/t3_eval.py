...
from Minerva7B.T1_Traduzione.T3_gemerazione_libera.training.t3_train import (base_ambiente, carica_split, carica_token, id_fine_turno,
...
def punteggio_contesto(model, tok, prompt, candidato, max_len=512):
    ...
    import torch
    from Minerva7B.T1_Traduzione.T3_gemerazione_libera.training.t3_train import logp_per_sequenza
    valori = []
    with torch.no_grad():
